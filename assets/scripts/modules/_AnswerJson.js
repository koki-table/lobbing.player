    ...
    this.dataJson.fetchJSONFile('/api/data/answerData.json', function(data) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        var answerData = (secAnswer.innerHTML +=
          ...
          i +
          '"><div class="mv__bg scroll-target"></div><div class="mv__img"><a href="' +
          data[i].link +
          '" target="_blank"><img src="' +
          data[i].img +
          '" alt=""></a></div><h2 class="mv__title">' +
          data[i].title +
          '</h2><p class="mv__sub-text">おすすめ動画はYouTubeマークをクリック！！<br>※別タブにて、YouTubeが開きます。</p><div class="mv__scroll"><div class="scroll"><div class="scroll__line"><div class="line"></div></div><p class="scroll__text">SCROLL</p></div></div></div></div><div class="answer__body" data-answer-body><div class="content scroll-trigger" data-answer-text-target="' +
          i +
          '"><p class="content__text">おすすめの卓球選手は' +
          data[i].title +
          'です。ぜひ動画を参考にしてみてください！</p></div><div class="appeal" data-appeal><div class="appeal__link" data-appeal-last><a href="https://twitter.com/Lobbing_?ref_src=twsrc%5Etfw"><img src="/assets/images/pages/index/return_btn_tw.png" alt="Twitterに戻る"></a></div><div class="appeal__text">『リツイートとフォローもしてくれたら喜びます!!』</div><div class="appeal__link appeal__link--return"><a href="" alt="">もう一度診断する</a></div></div></div></div>')
      }
